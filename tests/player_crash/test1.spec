...
mov.c%a(cond) [%b(immediate)], %c(reg) 
bbbbbbbbbbbbbbbbccccaaaa00000110

mov [%a(immediate)], %b(reg) 
...
mov %a(reg), [%b(reg) + %c(reg) + %d(immediate)] 
ddddccccbbbbaaaa00001001

mov %a(reg), [%b(reg) + 2 * %c(reg) + %d(immediate)] 
ddddccccbbbbaaaa00001010

mov %a(reg), [%b(reg) + 4 * %c(reg) + %d(immediate)] 
ddddccccbbbbaaaa00001011

mov %a(reg), [%b(reg) + 8 * %c(reg) + %d(immediate)] 
ddddccccbbbbaaaa00001100

mov %a(reg), [%b(reg) + 16 * %c(reg) + %d(immediate)] 
ddddccccbbbbaaaa00001101

mov [%a(reg) + %b(reg) + %c(immediate)], %d(reg) 
ddddccccbbbbaaaa00001110

mov [%a(reg) + 2 * %b(reg) + %c(immediate)], %d(reg) 
ddddccccbbbbaaaa00001111

mov [%a(reg) + 4 * %b(reg) + %c(immediate)], %d(reg) 
ddddccccbbbbaaaa00010000

mov [%a(reg) + 8 * %b(reg) + %c(immediate)], %d(reg) 
ddddccccbbbbaaaa00010001

mov [%a(reg) + 16 * %b(reg) + %c(immediate)], %d(reg) 
...
add %a(reg), %b(reg), %c(immediate) 
ccccbbbbaaaa000000010101

add %a(reg), %b(reg) 
bbbbaaaa00010110

add %a(reg), %b(immediate) 
bbbbaaaa00010111

add.c%a(cond) %b(reg), %c(immediate) 
...
sub %a(reg), %b(reg), %c(immediate) 
ccccbbbbaaaa000000011011

sub %a(reg), %b(reg) 
bbbbaaaa00011100

sub %a(reg), %b(immediate) 
bbbbaaaa00011101

sub.c%a(cond) %b(reg), %c(immediate) 
...
shl %a(reg), %b(reg), %c(immediate) 
ccccbbbbaaaa000000100001

shl %a(reg), %b(reg) 
bbbbaaaa00100010

shl %a(reg), %b(immediate) 
bbbbaaaa00100011

shl.c%a(cond) %b(reg), %c(immediate) 
...
shr %a(reg), %b(immediate) 
bbbbaaaa00101001

shr.c%a(cond) %b(reg), %c(immediate) 
...
or %a(reg), %b(reg), %c(immediate) 
ccccbbbbaaaa000000101101

or %a(reg), %b(reg) 
bbbbaaaa00101110

or %a(reg), %b(immediate) 
bbbbaaaa00101111

or.c%a(cond) %b(reg), %c(immediate) 
...
nor %a(reg), %b(reg), %c(immediate) 
ccccbbbbaaaa000000110011

nor %a(reg), %b(reg) 
bbbbaaaa00110100

nor %a(reg), %b(immediate) 
bbbbaaaa00110101

nor.c%a(cond) %b(reg), %c(immediate) 
...
nand %a(reg), %b(reg), %c(immediate) 
ccccbbbbaaaa000000111001

nand %a(reg), %b(reg) 
bbbbaaaa00111010

nand %a(reg), %b(immediate) 
bbbbaaaa00111011

nand.c%a(cond) %b(reg), %c(immediate) 
...
and %a(reg), %b(reg), %c(immediate) 
ccccbbbbaaaa000000111111

and %a(reg), %b(reg) 
bbbbaaaa01000000

and %a(reg), %b(immediate) 
bbbbaaaa01000001

and.c%a(cond) %b(reg), %c(immediate) 
...
xor %a(reg), %b(reg), %c(immediate) 
ccccbbbbaaaa000001001011

xor %a(reg), %b(reg) 
bbbbaaaa01001100

xor %a(reg), %b(immediate) 
bbbbaaaa01001101

xor.c%a(cond) %b(reg), %c(immediate) 
